...
#     """
#
#     @http.route('/university/dashboard', type='http', auth='user', website=True)
...
#         ExamResult = request.env['examination.result']
#         HallTicket = request.env['examination.hall.ticket']
#         Revaluation = request.env['examination.revaluation']
#
#         today = fields.Date.today()
#
